...
export default class Floor
{
	...
	private floorShape!: THREE.Shape
	private floorExtrudeOptions!: THREE.ExtrudeGeometryOptions
	...
	constructor()
	{
		...
		// {
		// 	this.debugFolder = this.gui.ui.addFolder('Floor')
		// 	this.debug()
		// }
	...
	// 		{
	// 			this.setFloor()
	// 			this.experience.world.paddles.setPaddles()
	// 			this.experience.world.floorLine.setAllLine()
	// 		})
